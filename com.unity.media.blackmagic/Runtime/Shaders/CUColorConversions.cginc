...
float3 YUV2RGB(float3 yuv)
{
    ...
    rgb = float3(
        /*r*/ y + 1.4747 * v,
        /*g*/ y - (0.2627 * 1.4747 / 0.6780) * v - (0.0593 * 1.8814 / 0.6780) * u,
        /*b*/ y + 1.8814 * u
    );
#ifndef YUV10Bit
    rgb = UnclipSignal(rgb);
...
#if BT2020 && WORKING_SPACE_CONVERSION
...
#ifdef WORKING_SPACE_CONVERSION
    // BT.2087 M2 (BT709 -> BT2020)
    rgb = float3(
        /*y*/ 0.6274 * rgb.r + 0.3293 * rgb.g + 0.0433 * rgb.b,
        /*u*/ 0.0691 * rgb.r + 0.9195 * rgb.g + 0.0114 * rgb.b,
        /*v*/ 0.0164 * rgb.r + 0.0880 * rgb.g + 0.8956 * rgb.b
    );
#endif
