...
#include "Packages/com.unity.render-pipelines.high-definition/Runtime/RenderPipeline/RenderPass/CustomPass/CustomPassCommon.hlsl"
	...
	float4 Compositing(Varyings varyings) : SV_Target
	{
		...
		float4 cg = _Background.Sample(s_point_clamp_sampler, posInput.positionNDC.xy);
		float4 overPixel = SAMPLE_TEXTURE2D_X_LOD(_OverLayer, s_point_clamp_sampler, posInput.positionNDC.xy, 0);
