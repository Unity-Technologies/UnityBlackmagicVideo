...
namespace Unity.Media.Blackmagic
{
    ...
    [ExecuteAlways]
    public sealed class BlackmagicOutputVideoBlitter : MonoBehaviour
    {
        [SerializeField]
        ...
        void InitializeMeshOutput()
        {
            ...
            ///m_Material.SetTexture("_MainTex", outputDevice.targetTexture);
        ...
        {
            if (m_Mesh == null || camera != GetComponent<Camera>() || !m_OutputDevice.IsActive())
                return;
