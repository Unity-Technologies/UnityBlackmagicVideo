...
namespace Unity.Media.Blackmagic
{
    ...
    [ExecuteAlways]
    public class BlackmagicCompositingCanvasBlitter : MonoBehaviour
    {
        class ShaderIDs
        {
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            else
            {
                ...
                if (m_CanvasReference.worldCamera != m_Camera)
                    m_CanvasReference.worldCamera = m_Camera;
            }
        }
        ...
        void BlitRenderTextureToScreen(Texture texture)
        {
            ...
            if (m_CanvasReference.worldCamera != m_CameraReference)
                m_CanvasReference.worldCamera = m_CameraReference;
        }
    }
}
